...
%prep
tar zxf \$RPM_SOURCE_DIR/${php73_filename}.tar.gz

%build
cd ${php73_filename}
./configure --prefix=${php73_location} \
...
install -D -m 0755 \$RPM_SOURCE_DIR/php73 \$RPM_BUILD_ROOT/etc/init.d/php73
install -D -m 0644 \$RPM_SOURCE_DIR/default.conf \$RPM_BUILD_ROOT/${php73_location}/etc/default.conf
...
[ $? -ne 0 ] && echo "[ERROR]: chkconfig --add php73"
...
rpmbuild_php73(){
    ...
    _create_fpm_config
    _create_spec
    rpmbuild -bb ~/rpmbuild/SPECS/php73.spec
}
