...
prefix=/hws.com/hwsmaster/server/apache-2_4_46
...
Source2:        ${apache2446_filename}.tar.gz
...
tar zxf \$RPM_SOURCE_DIR/${apache2446_filename}.tar.gz
...
rpmbuild_apache2446(){
    ...
    _create_sysv_script
    _create_spec
    rpmbuild -bb ~/rpmbuild/SPECS/apache2446.spec
}
