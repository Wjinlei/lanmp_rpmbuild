...
_create_spec(){
    cat > ~/rpmbuild/SPECS/nginx116.spec << EOF
Name:           hws-nginx
Version:        1.16.1
Release:        1%{?dist}
...
Source2:        ${nginx116_filename}.tar.gz
...
tar zxf \$RPM_SOURCE_DIR/${nginx116_filename}.tar.gz
...
rpmbuild_nginx116(){
    ...
    _create_sysv_script
    _create_spec
    rpmbuild -bb ~/rpmbuild/SPECS/nginx116.spec
}
