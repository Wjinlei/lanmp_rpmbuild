...
prefix=/hws.com/hwsmaster/server/php-5_2_17
...
_create_spec(){
    cat > ~/rpmbuild/SPECS/php52.spec << EOF
Name:           php52
Version:        5.2.17
Release:        1%{?dist}
Summary:        PHP 5.2.17
...
Packager:       hws
Source0:        ${php52_filename}.tar.gz
Source1:        ${php52_fpm_filename}
Source2:        ${php52_fixbug_nodec_filename}.tar.gz
Source3:        ${php52_fixbug_gmpc_filename}.tar.gz
...
%prep
tar zxf \$RPM_SOURCE_DIR/${php52_filename}.tar.gz
gzip -cd \$RPM_SOURCE_DIR/$php52_fpm_filename | patch -d $php52_filename -p1
tar zxf \$RPM_SOURCE_DIR/${php52_fixbug_nodec_filename}.tar.gz
patch -d ${php52_filename} -p0 < ${php52_fixbug_nodec_filename}.patch
tar zxf \$RPM_SOURCE_DIR/${php52_fixbug_gmpc_filename}.tar.gz
patch -d ${php52_filename} -p0 < ${php52_fixbug_gmpc_filename}.patch

%build
cd ${php52_filename}
./configure --prefix=${php52_location} \
...
install -D -m 0755 \$RPM_SOURCE_DIR/php52 \$RPM_BUILD_ROOT/etc/init.d/php52
install -D -m 0644 \$RPM_SOURCE_DIR/php-fpm.conf \$RPM_BUILD_ROOT/${php52_location}/etc/php-fpm.conf
install -D -m 0644 \$RPM_BUILD_DIR/${php52_filename}/php.ini-recommended \$RPM_BUILD_ROOT/${php52_location}/etc/php.ini
...
rpmbuild_php52(){
    php52_location=/hws.com/hwsmaster/server/php-5_2_17
    _install_php_depend
    ...
    mysql_location=/hws.com/hwsmaster/server/mysql
    Is64bit && with_libdir="--with-libdir=lib64" || with_libdir=""
    _create_sysv_script
    _create_fpm_config
    _create_spec
    rpmbuild -bb ~/rpmbuild/SPECS/php52.spec
}
